        ...
        <div class="container">
            ...
            <div class="column one column_column">
                <a href="#" class="flv_footer_grey">
                    <span class="flv_font_18">If you are interested in
                        <span class="themecolor">Be|</span>
                        <span class="flv_color_white">theme</span>, do not wait and
                        <span class="flv_color_white">BUY IT NOW!</span>
                    </span>
                </a>
            </div>
        </div>
            ...
            <div class="one-fourth column">
                ...
                <aside id="text-7" class="widget widget_text">
                    <div class="textwidget">
                        ...
                        <p>
                            <span class="big">
                                We love who we are and we are very
                                proud to be the part of your business
                            </span>
                        </p>
                        <p>
                            Curabitur sit amet magna quam. Praesent in libero vel
                            <span class="tooltip" data-tooltip="Quis accumsan dolor">
                                    turpis pellentesque
                                </span>
                            egestas sit amet vel nunc. Nunc lobortis dui neque quis.
                        </p>
                        ...
                        <ul>
                                ...
                                <a href="#">
                                    <div class="photo">
                                        <img width="80" height="80"
                                             src="{{asset('ashry/front/images/80x80.jpg')}}"
                                             class="scale-with-grid wp-post-image" alt="..." />
                                        <span class="c">4</span>
                                    </div>
                                    <div class="desc">
                                        <h6>Content builder for posts</h6>
                                        <span class="date"><i class="icon-clock"></i>May 13, 2015</span>
                                    </div>
                                </a>
                            </li>
                            <li class="post-186 post format-image has-post-thumbnail category-mobile category-photography category-uncategorized tag-design tag-html5 ">
                                <a href="#">
                                    ...
                                    <div class="desc">
                                        <h6>Post with vertical photo</h6>
                                        <span class="date"><i class="icon-clock"></i>May 13, 2015</span>
                                    </div>
                                </a>
                            </li>
